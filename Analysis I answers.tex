...
\begin{document}
	...
	\end{cases}$ ensures that $a$ will always be greater than or equal to all elements of $g(\{i \in N: 1 \le i \le n \increment\})$, since when $g(n \increment) \le b$, any element of $g(\{i \in N: 1 \le i \le n \increment\})$ is either $g(n \increment)$, which we know to be less or equal to $b$.
